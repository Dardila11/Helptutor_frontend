      ...
      <div className="sec3--container">
        ...
        <div className="steps step3">
          <div className="step--box">
            ...
            <p>
              Nuestra aula virtual tiene todo lo necesario para que realices las
              clases: Videoconferencia, pizarra, edición de documentos online...
            </p>
          </div>
          <div className="step--box step">
            <span>3</span>
        ...
        <div className="steps step4">
          <div className="step--box">
            ...
            <p>Nuestra plataforma te permite publicar los temas en que requieres asesorias
              y escoger los tutores que se postulen para ayudarte!
            </p>
          </div>
          <div className="step--box step">
            <span>4</span>
