...
import { useUpdateTutor } from 'src/hooks/useTutorInfo'
        ...
        <Box display="flex" flexDirection="column" justifyContent="center">
          <Formik
            ...
            onSubmit={(values) => {
              ...
              mutation.mutate([jsonValues, data.user.id])
            }}>
            {({
              errors,
              handleBlur,
                    ...
                    <Box
                      ...
                      <IconButton
                        ...
                        <Badge
                          overlap="circle"
                          badgeContent={
                            <EditRoundedIcon color="primary" fontSize="large" />
                          }>
                          <Avatar
                            id="avatarPhoto"
                  ...
                  <Grid item xs={12}>
                    <Box className={classes.inputs} display="flex">
                      ...
                      <TextField
                        id="txt_methodology"
                        error={Boolean(
                          touched.methodology && errors.methodology
                        )}
                        fullWidth
